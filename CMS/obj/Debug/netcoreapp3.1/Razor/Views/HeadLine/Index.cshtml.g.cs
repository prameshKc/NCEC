#pragma checksum "C:\Users\ACER\Documents\ranish\gitProj\NCEC\cms\Views\HeadLine\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "72c742f862a3f6fe676a52826de2832174c02641"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"72c742f862a3f6fe676a52826de2832174c02641", @"/Views/HeadLine/Index.cshtml")]
      ...
      <div class=""modal-body"">
           <input id=""idHL"" name=""idHL"" hidden/>
            ...
            <div class=""form-group"">
                ...
                <textarea id=""HLDes"" type=""text"" class=""form-control");
            WriteLiteral(@" form-control-sm"" autocomplete=""off"" placeholder=""Enter Description"" rows=""3""></textarea>
            </div>
      </div>
      ...
      <div class=""modal-body"">
           <input id=""idHLDel"" name=""idHLDel"" hidden/>
            <div class=""row"">
                <div class=""col-md-2""> 
          ");
            WriteLiteral(@"          <i class=""fa fa-question-circle"" style=""font-size: 50px; color: #4bb349;""></i>
                </div>
                <div class=""col-md-10"">
...
<script>
    $(function(){
        ...
        $('#bodyHL').on('click', '.editHL', function(){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $.each(data, function(i, val){
                    ...
                    h +='<");
            WriteLiteral(@"td style=""width: 13%;""><div class=""row""><div class=""col-md-6""><button type=""button"" data-id=""'+ val.id +'"" class=""editHL btn btn-sm btn-outline-info"">Edit</button></div>'+
                    '<div class=""col-md-6""><button type=""button"" data-id=""'+ val.id +'"" class=""deleteHL btn btn-sm btn-outline-danger"">Delete</button></td></div>';
                    h +='</tr>';
                    sn++;
                });
                $('#bodyHL').html(h);
